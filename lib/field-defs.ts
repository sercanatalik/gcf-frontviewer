...
// ---------------------------------------------------------------------------
// 4. Known columns (auto-derived from F — used as SQL injection allowlist)
// ---------------------------------------------------------------------------

export const KNOWN_COLUMNS = new Set<string>(Object.values(F))
...
export const radialCharts: RadialChartDef[] = [
  {
    ...
    title: "by Region",
    description: "Cash-Out distribution",
  ...
  },
  {
    key: "fundingByhmsSL2",
    title: "by Portfolio",
    description: "Cash out by portfolio",
    measure: { field: F.cashOut, aggregation: "sum" },
    groupBy: F.hmsSL2,
    limit: 6,
    centerLabel: "CashOut",
  ...
  },
  {
    ...
    title: "by Collateral Currency",
    description: "Collateral by currency",
  ...
  {
    key: "cashoutByCounterpartyType",
    title: "by Counterparty Type",
  ...
  },
  {
    ...
    description: "WWR by Country",
    measure: { field: F.cashOut, aggregation: "sum" },
    groupBy: F.cp_country,
    limit: 6,
    centerLabel: "Total",
    formatter: "currency",
  },
